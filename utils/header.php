    ...
    <div class = "col-md-12">
        <div class = "container">
            <div class = "jumbotron"><!--jumbotron-->
                <h1>Vellore Events Venues & Catering</h1><!--jumbotron heading-->
                <p><!--jumbotron content-->
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam purus felis, 
                congue nec mattis vitae, scelerisque condimentum metus. Nulla nec volutpat nulla. Aliquam sagittis finibus purus, a egestas tellus consequat.
                </p>
                <!--<p id="dateAndTime"></p>-->
            </div>
        </div>
